	...
	export default {
			...
			return {
				...
				answerList:[
					...
					},
					{
						...
						answerContent:"过去、现在、外来是时间的发展。随着时间的发展，必然会有越来越多的人认为中医是智商税。因为一方面知识会发展，旧知识不断被发现是错的；另一方面平均教育程度不断提高，新知识被越来越多的人知道。",
						time: "06-18"
					}
				]
			}
		...
		onLoad(option){
			uni.request({
				...
				success: (res) => {
					this.cardDetails = res.data.cardListTBA[0]; //option.index
				}
			});
		},
		methods: {
